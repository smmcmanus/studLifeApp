...
- (void)viewDidLoad {
    ...
    sportAuthors = [[NSMutableArray alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cellWithText.category.text = [[sportCategories objectAtIndex:indexPath.row] uppercaseString];
    cellWithText.title.text = [sportTitles objectAtIndex:indexPath.row];
    cellWithText.author.text = [sportAuthors objectAtIndex:indexPath.row];
    
    NSString *dateSubstring = [[sportDates objectAtIndex:indexPath.row] substringToIndex:10];
    ...
    NSString *excerpts = [self stringByStrippingHTML:[sportExcerpts objectAtIndex:indexPath.row]];
    cellWithText.text.text = excerpts;
    cellWithText.tag = [[sportIds objectAtIndex:indexPath.row] integerValue];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"showDetail"])
    {
        ...
        controller.articleID = [[sportIds objectAtIndex:_index]integerValue];
    }
}

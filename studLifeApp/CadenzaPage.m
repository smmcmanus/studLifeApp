                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
                               ...
                               for(int i = 0; i < 100; i++){
                                   ...
                                   if([url containsString:@"cadenza"]){
                                       ...
                                       [cadenzaTitles insertObject:title atIndex: counter];
                                       [cadenzaIds insertObject:idNum atIndex:counter];
                                       counter++;
                                   }
                               }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [cadenzaTitles objectAtIndex:indexPath.row];
    cell.tag = [[cadenzaIds objectAtIndex:indexPath.row] integerValue];

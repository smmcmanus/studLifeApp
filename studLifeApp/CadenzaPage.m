...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cellWithText.category.text = [[cadenzaCategories objectAtIndex:indexPath.row] uppercaseString];
    cellWithText.title.text = [cadenzaTitles objectAtIndex:indexPath.row];
    cellWithText.author.text = [cadenzaAuthors objectAtIndex:indexPath.row];
    
    NSString *dateSubstring = [[cadenzaDates objectAtIndex:indexPath.row] substringToIndex:10];
    ...
    NSString *excerpts = [self stringByStrippingHTML:[cadenzaExcerpts objectAtIndex:indexPath.row]];
    cellWithText.text.text = excerpts;
    cellWithText.tag = [[cadenzaIds objectAtIndex:indexPath.row] integerValue];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"showDetail"])
    {
        ...
        controller.articleID = [[cadenzaIds objectAtIndex:_index]integerValue];
    }
}
